...
3.  **Vertex AI & Google AI Studio (Gemini 1.5 Pro):** Replaces generic ML pipelines. Handles complex multimodal reasoning (analyzing video feeds and audio sentiment) when escalated by the edge agent.
