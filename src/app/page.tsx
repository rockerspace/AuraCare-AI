    ...
    >
      ...
      <main className="ml-64 p-8 relative z-10">
        <header className="flex justify-between items-center mb-10">
          <div>
            <h2 className="text-2xl font-semibold drop-shadow-md">Overview</h2>
            <p className="text-neutral-300 text-sm mt-1 drop-shadow-md">Monitoring Jane Doe (Age 82) • Last synced: Just now</p>
          </div>
