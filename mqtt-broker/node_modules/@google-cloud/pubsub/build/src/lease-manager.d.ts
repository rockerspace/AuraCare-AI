...
import { LoggingFunction } from './logs';
/**
...
export declare const logs: {
    callbackDelivery: LoggingFunction;
    callbackExceptions: LoggingFunction;
    expiry: LoggingFunction;
    subscriberFlowControl: LoggingFunction;
};
