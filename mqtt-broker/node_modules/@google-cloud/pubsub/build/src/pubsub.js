...
class PubSub {
    ...
    constructor(options) {
        ...
        const clientClasses = [_1.v1.SubscriberClient, _1.v1.PublisherClient];
        const allScopes = {};
    ...
    async getSchemaClient() {
        if (!this.schemaClient) {
            ...
            this.schemaClient = new _1.v1.SchemaServiceClient(options);
        }
    ...
    async getClientAsync_(config) {
        ...
        if (!gaxClient) {
            ...
            gaxClient = new _1.v1[config.client](options);
